...
def triangle_calculation(A, B, C):
    ...
    triangle_area = math.sqrt(triangle_semi_perimeter * (triangle_semi_perimeter - a) * (triangle_semi_perimeter - b) * (triangle_semi_perimeter - c))
...
while True:
    ...
    cv2.putText(frame, f"Perimeter: " + "{:.0f}".format(triangle_perimeter), (5, 60), font, 1, (255, 0, 255), 2, cv2.LINE_AA)
    cv2.putText(frame, f"Area: " + "{:.0f}".format(triangle_area), (5, 90), font, 1, (255, 0, 255), 2, cv2.LINE_AA)
