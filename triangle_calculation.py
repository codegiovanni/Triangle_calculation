...
def select_color(event, x, y, flags, param):
    global hue, pt1_x, pt1_y, pt2_x, pt2_y, line_scaler, scale_defined, height, width, H0, H1, V0, V1
    ...
    if x > 100 and y > 100 and x < width - 100 and y < height - 100:
...
while True:
    ...
    zoomed = zoom(frame, 2)
    cv2.circle(zoomed, (200, 200), 5, (255, 255, 255), -1)
    cv2.imshow('zoom_search', zoomed)
